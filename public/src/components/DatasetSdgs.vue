<template>
  <div v-if="data">
    ...
    <!-- Navbar Start -->
    <div class="sticky-top" style="z-index: 0;padding-top: 72px;margin-top:-72px;z-index:1">
            ...
            <div class="card-body">
              ...
              <div class="row mt-4">
                <div class="col-md-12 text-center">
                  <a :href="getDatasetUrl(data.file)" id="visualizea" class="btn btn-success">
                    Download Dataset
                  </a>
                </div>
              </div>
    ...
    <div class="row mt-4">
      <div class="col-md-12 text-center">
        <button id="downloadButton" class="btn btn-success" @click="print">
